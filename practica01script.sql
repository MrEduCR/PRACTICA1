...
CREATE TABLE arbol (
    ...
    CONSTRAINT fk_estado_arbol
        FOREIGN KEY (id_estado)
        REFERENCES estado_arbol(id_estado)
        ON UPDATE CASCADE
        ON DELETE SET NULL
);
...
('Cedro', 'Pequeña amarilla', 'Dura', 20.0, 'https://thumbs.dreamstime.com/b/%C3%A1rbol-de-cedro-aislado-46771243.jpg?w=576', 2),
